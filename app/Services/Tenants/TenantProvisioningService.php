...
class TenantProvisioningService
{
    ...
    {
        LeavePolicy::query()->firstOrCreate(['code' => 'LEAVE_DEFAULT'], [
        ...
        AttendancePolicy::query()->firstOrCreate(['code' => 'ATTENDANCE_DEFAULT'], [
        ...
        HolidayPolicy::query()->firstOrCreate(['code' => 'HOLIDAY_DEFAULT'], [
        ...
        PayrollPolicy::query()->firstOrCreate(['code' => 'PAYROLL_DEFAULT'], [
        ...
        ProbationPolicy::query()->firstOrCreate(['code' => 'PROBATION_DEFAULT'], [
        ...
        NoticePeriodPolicy::query()->firstOrCreate(['code' => 'NOTICE_DEFAULT'], [
        ...
        OvertimePolicy::query()->firstOrCreate(['code' => 'OVERTIME_DEFAULT'], [
        ...
        WfhPolicy::query()->firstOrCreate(['code' => 'WFH_DEFAULT'], [
        ...
        ReimbursementPolicy::query()->firstOrCreate(['code' => 'REIMBURSE_DEFAULT'], [
        ...
        CodeOfConductPolicy::query()->firstOrCreate(['code' => 'COC_DEFAULT'], [
