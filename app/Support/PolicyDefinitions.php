...
/**
 * Central registry of all HR policy type definitions.
 * Extracted from PolicyManagementController to follow the Single Responsibility Principle.
 * Each definition maps a URL slug to its model class, display info, and field schema.
 */
class PolicyDefinitions
{
    /**
     * Return all policy definitions keyed by their route slug.
     *
     * @return array<string, array{title: string, description: string, model: class-string, fields: array}>
     */
        ...
        return [
            'leave' => [
                ...
                'fields'      => [
                    ...
                    ['name' => 'rules',              'label' => 'Rules',             'type' => 'json'],
                    ['name' => 'exceptions',         'label' => 'Exceptions',        'type' => 'json'],
            ...
            'attendance' => [
                ...
                'fields'      => [
                    ...
                    ['name' => 'max_late_marks_per_month', 'label' => 'Max Late Marks/Month',  'type' => 'integer'],
            ...
            'holiday' => [
                ...
                'fields'      => [
                    ...
                    ['name' => 'weekend_days', 'label' => 'Weekend Days',   'type' => 'json'],
                    ['name' => 'rules',        'label' => 'Rules',          'type' => 'json'],
                ],
            ],
            ...
            'overtime' => [
                ...
                'fields'      => [
                    ...
                    ['name' => 'max_hours_per_month', 'label' => 'Max Hours/Month',    'type' => 'number'],
                    ['name' => 'rules',               'label' => 'Rules',              'type' => 'json'],
                ],
            ],
            ...
            'wfh' => [
                ...
                'fields'      => [
                    ...
                    ['name' => 'allowed_departments',  'label' => 'Allowed Departments',   'type' => 'json'],
                    ['name' => 'allowed_roles',        'label' => 'Allowed Roles',         'type' => 'json'],
                    ['name' => 'rules',                'label' => 'Rules',                 'type' => 'json'],
                ],
            ],
            ...
            'reimbursement' => [
                ...
                'fields'      => [
                    ...
                    ['name' => 'allowed_categories',  'label' => 'Allowed Categories',   'type' => 'json'],
                    ['name' => 'approval_matrix',     'label' => 'Approval Matrix',      'type' => 'json'],
                    ['name' => 'rules',               'label' => 'Rules',                'type' => 'json'],
                ],
            ],
            ...
            'code-of-conduct' => [
                ...
                'fields'      => [
                    ...
                    ['name' => 'breach_actions',          'label' => 'Breach Actions',          'type' => 'json'],
                    ['name' => 'rules',                   'label' => 'Rules',                   'type' => 'json'],
                ],
            ],
        ];
    ...
    /**
     * Resolve a single definition or throw a 404.
     *
     * @param  string  $type
     * @return array
     */
    ...
    {
        $definitions = static::all();
        abort_unless(isset($definitions[$type]), 404, "Unknown policy type: {$type}");
