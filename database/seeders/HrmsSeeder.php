...
class HrmsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        LeaveRequest::insert([
            ['employee_id' => $employees[2]->id, 'leave_type' => 'sick', 'start_date' => now()->subDays(2), 'end_date' => now()->addDays(2), 'reason' => 'Medical recovery', 'status' => 'approved', 'created_at' => now(), 'updated_at' => now()],
            ['employee_id' => $employees[1]->id, 'leave_type' => 'annual', 'start_date' => now()->addDays(7), 'end_date' => now()->addDays(10), 'reason' => 'Family travel', 'status' => 'pending', 'created_at' => now(), 'updated_at' => now()],
        ]);
