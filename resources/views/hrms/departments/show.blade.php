...
<div class="mb-8 flex items-center justify-between">
    <div>
        ...
        <p class="text-slate-400">Code: {{ $department->code }}</p>
    </div>
...
<div class="grid gap-6 md:grid-cols-3">
    <div class="rounded-2xl border border-slate-800 bg-slate-900 p-6">
        ...
        <div class="space-y-4">
            <div>
                ...
                <p class="mt-1 text-white">{{ $department->name }}</p>
            </div>
            <div>
                <p class="text-sm text-slate-400">Code</p>
                <p class="mt-1 text-white">{{ $department->code }}</p>
            </div>
            <div>
                <p class="text-sm text-slate-400">Lead</p>
                <p class="mt-1 text-white">{{ $department->lead_name }}</p>
            </div>
            <div>
    ...
    <div class="md:col-span-2 rounded-2xl border border-slate-800 bg-slate-900 p-6">
        ...
        <div class="space-y-3">
            ...
            @empty
                <p class="text-slate-400">No employees in this department.</p>
            @endforelse
        </div>
    </div>
</div>
