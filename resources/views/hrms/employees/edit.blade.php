    ...
    <form method="POST" action="{{ route('employees.update', $employee->id) }}" class="space-y-4">
        ...
        <div class="grid gap-4 md:grid-cols-2">
            <div>
                ...
                <input type="text" name="full_name" class="mt-1 w-full rounded-lg border border-slate-700 bg-slate-950 px-3 py-2 @error('full_name') border-red-500 @enderror" value="{{ old('full_name', $employee->full_name) }}" required>
                @error('full_name')
            ...
            <div>
                ...
                <input type="email" name="email" class="mt-1 w-full rounded-lg border border-slate-700 bg-slate-950 px-3 py-2 @error('email') border-red-500 @enderror" value="{{ old('email', $employee->email) }}" required>
                @error('email')
                    <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="tel" name="phone" class="mt-1 w-full rounded-lg border border-slate-700 bg-slate-950 px-3 py-2 @error('phone') border-red-500 @enderror" value="{{ old('phone', $employee->phone) }}" required>
                @error('phone')
                    <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="text" name="job_title" class="mt-1 w-full rounded-lg border border-slate-700 bg-slate-950 px-3 py-2 @error('job_title') border-red-500 @enderror" value="{{ old('job_title', $employee->job_title) }}" required>
                @error('job_title')
                    <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="number" step="0.01" min="0" name="salary" class="mt-1 w-full rounded-lg border border-slate-700 bg-slate-950 px-3 py-2 @error('salary') border-red-500 @enderror" value="{{ old('salary', $employee->salary) }}" required>
                @error('salary')
                    <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="date" name="joined_on" class="mt-1 w-full rounded-lg border border-slate-700 bg-slate-950 px-3 py-2 @error('joined_on') border-red-500 @enderror" value="{{ old('joined_on', $employee->joined_on->format('Y-m-d')) }}" required>
                @error('joined_on')
                    <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                @enderror
            </div>
        ...
        <div class="flex gap-3 pt-4">
            ...
            <a href="{{ route('employees.show', $employee->id) }}" class="rounded-lg border border-slate-700 px-6 py-2 font-semibold text-slate-300 hover:bg-slate-800">Cancel</a>
        </div>
    </form>
</div>
@endsection
