<div class="space-y-8 pb-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
        @foreach($policies as $policy)
            <div class="group relative flex flex-col rounded-[1.5rem] border border-slate-200 bg-white p-5 shadow-sm dark:border-white/5 dark:bg-slate-900 transition-all hover:shadow-xl hover:border-emerald-400/30">
                <div class="flex items-start justify-between mb-6">
                    <div class="h-14 w-14 flex items-center justify-center rounded-xl bg-emerald-50 font-black text-[15px] text-emerald-600 shadow-inner dark:bg-emerald-500/10 dark:text-emerald-400 transition-transform group-hover:scale-110">
                ...
                <h4 class="text-base font-black text-slate-900 dark:text-white uppercase tracking-tight truncate">{{ $policy['title'] }}</h4>
